...
import { WHATSAPP_NUMBERS, FACEBOOK_LINK } from '../utils/constants'
        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">BioBooks</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-4">{t('contact.whatsapp')}</h4>
            {WHATSAPP_NUMBERS.map((wa) => (
              <a
                key={wa.number}
                href={wa.link}
                className="block text-gray-400 hover:text-green-400 transition-colors mb-2 dir-ltr"
              >
                {wa.number}
              </a>
            ))}
